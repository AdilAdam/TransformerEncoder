...
class Conf(object):
    ...
    def __init__(
        ...
        # type: (str, int, str, bool, bool, bool, str) -> None
        """
        ...
        if self.log_enabled:
            ...
            if not resume:
                exp_name = (
                    f"{exp_name}.{current_time.year}.{current_time.month}.{current_time.day}.{current_time.hour}."
